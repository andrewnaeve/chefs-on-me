            ...
            <div style={navStyle} className="row">
              <div className="navbar navbar-inverse navbar-fixed-top">
                ...
                <ul className="nav navbar-nav navbar-right" >
                  ...
                  <li>
                    <a style={aStyle} href ="#about" data-toggle="modal">About Us</a>
                  </li>
                  <li>
                    <a style={aStyle} href ="#team" data-toggle="modal">Meet the Team</a>
                  </li>
                  <li>
                    <a style={aStyle} href ="#tutorial" data-toggle="modal">How it Works</a>
                  </li>
                  <li>
                    <a style={aStyle} href="#search">Find A Chef</a>
                  </li>
                  <li>
                    <a style={aStyle} href="#signup" data-toggle="modal">Sign Up / Login</a>
                  </li>
                  </ul>
                </div>
              </div>
