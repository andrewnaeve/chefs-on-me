		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'form',
						{ onSubmit: this.onButtonClick, className: 'create-update-form' },
						React.createElement(
							'div',
							...
							React.createElement('input', { type: 'text', className: 'form-control', id: 'name', 'aria-describedby': 'Name', placeholder: 'Full Name', ref: 'name' })
						),
						React.createElement(
							'div',
							{ className: 'form-group' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Search = React.createClass({
	    ...
	    changeState: function changeState(newSearch) {
	        this.setState({
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'h1',
	                    null,
	                    'Lets match you up with a nearby Chef.'
	                ),
	                ...
	                React.createElement(
	                    'button',
	                    { type: 'submit', className: 'btn btn-default', id: 'searchBtn' },
	                    'Search'
	                )
	            ),
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'a',
	                { style: aStyle, href: '#team', 'data-toggle': 'modal' },
	                'Meet the Team'
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement(
	                'a',
	                { style: aStyle, href: '#tutorial', 'data-toggle': 'modal' },
	                'How it Works'
	              )
	            ),
	            React.createElement(
